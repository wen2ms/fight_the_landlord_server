...
const char descriptor_table_protodef_information_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\030\007 \001(\0162\r.ResponseCode*\237\001\n\013RequestCode\022\016\n"
  ...
  "LORD\020\006\022\017\n\013PLAY_A_HAND\020\007*\323\001\n\014ResponseCode"
  "\022\014\n\010LOGIN_OK\020\000\022\017\n\013REGISTER_OK\020\001\022\024\n\020RSA_D"
  "ISTRIBUTION\020\002\022\021\n\rAES_VERIFY_OK\020\003\022\020\n\014JOIN"
  "_ROOM_OK\020\004\022\016\n\nSTART_GAME\020\005\022\022\n\016SEARCH_ROO"
  "M_OK\020\006\022\016\n\nDEAL_CARDS\020\007\022\022\n\016OTHER_BID_LORD"
  "\020\010\022\025\n\021OTHER_PLAY_A_HAND\020\t\022\n\n\006FAILED\020\nb\006p"
  "roto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_information_2eproto = {
    false, false, 565, descriptor_table_protodef_information_2eproto,
    "information.proto",
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Information.user_name"));
        } else
          goto handle_unusual;
        continue;
      // string room_name = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Information.room_name"));
        } else
          goto handle_unusual;
        continue;
      // string data1 = 3;
